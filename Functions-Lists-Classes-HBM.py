...
# Programming Assignment: Case Study-Functions, Lists, and Classes
...
# Write an app that will accept user input for a car. The app will store "car"
# into the vehicle type in your Vehicle super class. 
# The app will then ask the user for the year, make, model, doors, and type of 
# roof and store thdata in the attributes above.
